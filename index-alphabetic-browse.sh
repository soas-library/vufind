...
build_browse "callnumber" "full_callnumber_browse"
#build_browse "callnumber" "full_callnumber_browse" 1 "-Dbibleech=StoredFieldLeech -Dsortfield=callnumber -Dvaluefield=full_callnumber_browse"
