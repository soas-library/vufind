...
function buildFacetNodes(data, currentPath, allowExclude, excludeTitle, counts)
{
  ...
  $(data).each(function facetNodesEach() {
    ...
    if (!this.isApplied && counts) {
      ...
      html = ' <a class="exclude" href="' + excludeURL + '" onclick="document.location.href=\'' + excludeURL + '\'; return false;" title="' + htmlEncode(excludeTitle) + '"><i class="fa fa-times" title="' + VuFind.translate('Selected') + '"></i></a>';
