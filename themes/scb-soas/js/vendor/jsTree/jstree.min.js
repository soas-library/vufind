...
(function(e) {
    ...
    if (!e.jstree) {
        var i = 0,
            ...
            c, h;
        l.setAttribute("role", "treeitem"), c = d.createElement("I"), c.className = "jstree-icon1 jstree-ocl", l.appendChild(c), c = d.createElement("A"), c.className = "jstree-anchor tree_facet", c.setAttribute("href", "#"), h = d.createElement("I"), h.className = "jstree-icon1 jstree-themeicon", c.appendChild(h), l.appendChild(c), c = h = null, e.jstree = {
                version: "3.0.0",
                defaults: {
                    plugins: []
                },
