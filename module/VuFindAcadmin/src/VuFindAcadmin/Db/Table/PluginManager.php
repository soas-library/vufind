 ...
 * @link     https://vufind.org/wiki/development:plugins:database_gateways Wiki
 */
class PluginManager extends \VuFindAcadmin\ServiceManager\AbstractPluginManager
{
    /**
     * Constructor
     *
    ...
    public function __construct(ConfigInterface $configuration = null)
    {
        ...
        $initializer = function ($instance, $manager) {
            $instance
                ->setAdapter($manager->getServiceLocator()->get('VuFindAcadmin\DbAdapter'));
            $instance->initialize();
        };
    ...
    {
        return 'VuFindAcadmin\Db\Table\Gateway';
    }
}
