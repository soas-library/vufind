...
class Gateway extends AbstractTableGateway implements ServiceLocatorAwareInterface
{
    ...
    public function initialize()
    {
        ...
        if ($this->adapter->getDriver()->getDatabasePlatformName() == "Postgresql") {
            ...
            $maps = isset($cfg['vufindacadmin']['pgsql_seq_mapping'])
                ? $cfg['vufindacadmin']['pgsql_seq_mapping'] : null;
    ...
    protected function initializeRowPrototype()
    {
        ...
        \VuFindAcadmin\ServiceManager\Initializer::initInstance(
    ...
    public function createRow()
    {
        ...
        if ($this->adapter
            ...
            && $obj instanceof \VuFindAcadmin\Db\Row\RowGateway
        ) {
