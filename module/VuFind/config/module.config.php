...
$config = [
    ...
    'controllers' => [
        ...
        'invokables' => [
            ...
            /** SCB **/
            'postcallback' => 'VuFind\Controller\PostCallbackController',
            /** SCB **/
    ...
    'vufind' => [
        ...
        'plugin_managers' => [
            ...
            'recordtab' => [
                ...
                'factories' => [
                    ...
                    'collectiondescription' => 'VuFind\RecordTab\Factory::getCollectionDescription',
        ...
        'recorddriver_tabs' => [
            ...
            'VuFind\RecordDriver\SolrDefault' => [
                ...
                'defaultTab' => null,
                'backgroundLoadedTabs' => ['Description', 'Notes', 'TOC', 'UserComments', 
                //'Reviews', 'Excerpt', 'Preview', 'HierarchyTree', 
                'Reviews', 'Excerpt', 'Preview',
                'Map', 'Similar', 'Details']
            ],
            ...
            'VuFind\RecordDriver\SolrSobek' => [
                ...
                'backgroundLoadedTabs' => ['Description', 'TOC', 'UserComments', 
                'Reviews', 'Excerpt', 'Preview', 'HierarchyTree', 
                'Map', 'Similar', 'Details']
            ],
            'VuFind\RecordDriver\SolrArchive' => [
                'tabs' => [
                    //#'Holdings' => 'HoldingsILS', 
                    'Description' => 'Description',
                    'TOC' => 'TOC', 'UserComments' => 'UserComments',
...
$staticRoutes = [
    ...
    /** SCB **/
    'MyResearch/PaymentCallback', 'MyResearch/TestBillPayment','PostCallBack/PaymentCallback',
    /** SCB **/
    ...
    /** SCB **/
    'MyResearch/PaymentCancel', 'MyResearch/PaymentSuccess',
    /** SCB **/
