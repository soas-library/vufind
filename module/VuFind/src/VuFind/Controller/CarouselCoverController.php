...
use VuFind\Cover\CachingProxy, VuFind\Cover\CarouselLoader;
 ...
 * @link     https://vufind.org Main Page
 */
class CarouselCoverController extends AbstractBase
{
    /**
     * Cover loader
     *
    ...
    protected function getLoader()
    {
        ...
        if (!$this->loader) {
            ...
            $this->loader = new CarouselLoader(
                $this->getConfig(),
    ...
    protected function getImageParams()
    {
        ...
        /*return [
            ...
            'collection' => $params()->fromQuery('collection'),
        ];*/
    }
